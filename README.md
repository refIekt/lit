...
Lit lets you create console logs that are only visible after prefixing a command with `lit`. You can use flags to filter the types of logs and step through your application at runtime, essentially turning your logs into breakpoints (includes [Pry](https://github.com/pry/pry) support). Lit was originally created to view metadata generated by [Reflekt](https://reflekt.dev) but is useful in a wide range of applications.
